/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.toml --env-file=/dev/null` (hash: 09127999be2e0daf640f12e30c33e0ba)
...
interface __BaseEnv_Env {
	...
	THEOLOGAI_CCEL_COORDINATOR: DurableObjectNamespace<import("./src/worker").CcelGlobalCoordinator>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "THEOLOGAI_VERSION" | "THEOLOGAI_ALLOWED_ORIGINS" | "THEOLOGAI_MAX_REQUEST_BYTES" | "THEOLOGAI_REQUEST_LOGS" | "THEOLOGAI_ENABLE_CCEL_LIVE_SEARCH" | "THEOLOGAI_ENABLE_CCEL_COORDINATOR">> {}
}
