...
function discoverCanonicalFiles(): string[] {
  return [
    ...
    'data/historical-source-packs/core-eight/editions/anselm-proslogion-deane-1903.json',
    'data/historical-source-packs/core-eight/editions/athanasius-on-incarnation-robertson-npnf2-v4.json',
    'data/historical-source-packs/core-eight/editions/augustine-confessions-pusey-1838.json',
    'data/historical-source-packs/core-eight/editions/bunyan-pilgrims-progress-part-1.json',
    'data/historical-source-packs/core-eight/editions/calvin-institutes-beveridge-1845.json',
    'data/historical-source-packs/core-eight/editions/irenaeus-against-heresies-anf1-1885.json',
    'data/historical-source-packs/core-eight/editions/john-damascene-exposition-salmond-npnf2-v9.json',
    'data/historical-source-packs/core-eight/editions/wesley-standard-sermons-1771.json',
    'data/historical-source-packs/core-eight/manifest.json',
    'data/historical-source-packs/core-eight/manifest.sha256',
    ...relativeDataFiles('data/historical-source-packs/historical-spine-early/editions', '.json'),
    'data/historical-source-packs/historical-spine-early/manifest.json',
    'data/historical-source-packs/historical-spine-early/manifest.sha256',
    ...
    'data/historical-sources/eebo-tcp/A17662/SOURCE.json',
