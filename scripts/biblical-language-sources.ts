...
export function sourceLockProjection() {
  return {
    ...
    derived_artifacts: {
      ...
      d1_materialization_identity: '652245709aaed181345b0cf17f0091471ac3a3e323f6ae84cfd73a5d8b409c51',
      ...
      tracked_content_inventory_sha256: 'caf58814f24cc72837586c901c42f3556b59e45ec81bb0af7f5cfb9fa1629dcd',
      clean_reproduction_content_inventory_sha256: 'caf58814f24cc72837586c901c42f3556b59e45ec81bb0af7f5cfb9fa1629dcd',
      tracked_raw_inventory_sha256: '35649745857b65dbe87d024d13288036710272a193179349088f7a4af138268a',
      ...
      unicode_correction: {
        ledger: 'data/biblical-languages/UNICODE-CORRECTION.json',
        legacy_d1_materialization_identity: '91afa5bcf8155ac9f8c5fd14d1d661657c83be9a8e5cd90a5783bfa38ae7dfa5',
        legacy_content_inventory_sha256: '3661deb0e2c912bd3ca4ac1a815a118f0397a186d816c0bfe17e25d276f9fa4d',
        corrected_content_inventory_sha256: 'caf58814f24cc72837586c901c42f3556b59e45ec81bb0af7f5cfb9fa1629dcd',
        corrected_content_artifacts: 45,
        unchanged_runtime_artifacts: 27,
        source_cells: 246,
        d1_cells: 255,
        strongs_cells: 9,
        strongs_fts_cells: 9,
        morphology_cells: 237,
        attested_restoration: 'John 1:1 position 11 text τὸ → τὸν (lemma ὁ; Strong G3588; morph T-ASM).',
      },
      explanation: 'The 45 historically corrupted runtime artifacts were replaced by content-reproducible builds from exact byte-verified source pins. The committed ledger preserves every source-cell correction and proves the legacy semantic state by reverse projection. Gzip JSON is identified by its canonical decompressed payload, not platform-dependent container bytes.',
      policy: 'Reproduction must remain clean by portable content identity; any source, compiler, semantic, content-artifact, or correction-ledger drift requires explicit review.',
    },
