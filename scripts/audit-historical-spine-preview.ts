...
const EXPECTED_FIXTURE = {
  ...
  probes: [
    ...
    { workId: 'origen-de-principiis', editionId: 'origen-de-principiis-crombie-anf4-1885', sourcePackId: 'theologai-historical-spine-early', query: 'God is a body', sectionCount: 32, firstSection: { sectionKey: 'section-on-god-001', sourceOrdinal: 1 }, requiresPagination: false },
