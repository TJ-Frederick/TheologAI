  ...
  return {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        mode: { type: 'string', enum: ['auto', 'synoptic', 'quotation', 'thematic'], default: 'auto', description: 'TheologAI legacy corpus only; requires corpora to include theologai_legacy.' },
        ...
        maxParallels: { type: 'integer', minimum: 1, maximum: 50, default: 10, description: 'TheologAI legacy corpus only.' },
        ...
        useCrossReferences: { type: 'boolean', default: false, description: 'Deprecated alias for includeOpenBibleCrossReferences. Conflicting values are rejected.' },
      },
      required: ['reference'],
