/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.ccel-coordinator.toml --env-file=/dev/null ccel-coordinator-configuration.d.ts` (hash: a17100c6ccfa332cec17972e4f499b3d)
