...
As of the 2026-07-24 read-only inventory, the retained preview predecessor is deployment `7f00a94b-4ff4-47d6-9bee-2efb99673718`, Worker version `f78d66f1-cefe-46ba-88ba-9ddec259cda4` (#112), bound to `theologai-preview-20260722-b` (`94c4938b-7800-4d68-9097-0df33c31fdc1`). No separately prepared Transform-9 candidate D1 has been created or approved yet. That is a PR95 data-readiness condition—not a generic prohibition on code-only releases using the retained D1.
