...
reviewed core eight). The integrated Transform-10 Aquinas authority hierarchy
is local-only and unpublished, with no document/catalog, runtime, or MCP
projection. Production remains on its existing 17-work Transform-8 D1
collection until a separately authorized candidate is prepared, bound,
...
2. It runs the deterministic readiness query plus Transform-8 and Transform-9
   authority audits and Transform-10 inactive-hierarchy integrity checks
   against that exact name.
