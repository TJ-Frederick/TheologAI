...
describe('custom-domain infrastructure contract', () => {
  it('keeps production and preview routes, D1, and rate limits isolated while retaining workers.dev', async () => {
    ...
    expect(production).toContain('database_name = "theologai-production-20260728-normal-a"');
    expect(production).toContain('database_id = "a3d26bba-7adc-44b0-86d0-562b2ced6bd3"');
    ...
    expect(preview).toContain('database_name = "theologai-preview-20260728-hierarchy-a"');
    expect(preview).toContain('database_id = "51890e12-1c3f-421f-b661-9a5ea9637e43"');
