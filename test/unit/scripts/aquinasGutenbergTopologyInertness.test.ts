...
const foundationPath = 'src/kernel/sectionedEditionCollectionFoundation.ts';
const foundationReference = /sectionedEditionCollectionFoundation/;

describe('Aquinas Gutenberg topology foundation remains inert', () => {
  ...
  it('has no package, worker, catalog, database, or materialization registration', () => {
