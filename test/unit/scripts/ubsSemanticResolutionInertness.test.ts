...
describe('uncomposed legacy UBS semantic resolution seam', () => {
  ...
  it('keeps semantic resolution uncomposed alongside the Transform 13 historical release', () => {
    ...
    expect(manifest).toMatchObject({
      schemaVersion: '0010_active_aquinas_hierarchy_publication',
      materializations: { d1: { transformVersion: 13 } },
    });
  });
});
